...
const ProductModal = ({ product, onClose }) => (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
        <div className="bg-white grid grid-cols-2 md:w-4/5 md:h-4/6 rounded relative p-8 gap-8">
            <button
            ...
            <div className="max-h-max">
                <img src={product.main_image_url} alt={product.title} className="w-9/12 h-auto object-cover rounded-lg mb-4 aspect-square " />
            </div>
            <div className="flex flex-col h-full ">
                ...
                <Pill text="Comprar" className="!w-full !h-10 bg-gradient-to-r from-pink-300 to-purple-300 mt-auto"/>
